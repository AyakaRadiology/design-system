...
const isTailwindNamespace = (name: string, selector: string) =>
    selector.startsWith("@theme") && TAILWIND_NAMESPACES.some((prefix) => name.startsWith(prefix));
