...
export function Numeric({ value, unit, precision = DEFAULT_PRECISION, reservedChars = DEFAULT_RESERVED_CHARS, reservedUnitChars, showUnitWhenEmpty = false, children, className, ...props }) {
    if (value === undefined) {
    ...
    return (_jsxs("span", { className: cn("inline-flex items-baseline gap-1 font-mono tabular-nums", className), ...props, children: [_jsx("span", { "data-slot": "value", className: "ds-numeric-slot inline-block shrink-0 whitespace-nowrap text-right", style: { "--ds-numeric-chars": reservedChars }, children: empty ? (_jsxs(_Fragment, { children: [_jsx("span", { "aria-hidden": "true", className: "ds-numeric-empty text-text-tertiary", children: EMPTY_GLYPH }), _jsx("span", { className: "sr-only", children: "No value" })] })) : (value.toFixed(precision)) }), typeof unit === "string" && (!empty || showUnitWhenEmpty) && (_jsx("span", { "data-slot": "unit", className: cn("ds-numeric-slot inline-block shrink-0 whitespace-nowrap normal-case", empty ? "text-text-tertiary" : "text-text-secondary"), style: {
