 ...
 * size a container.
 */
const OFF_SCALE_SPACING = /\b(?:p|px|py|pt|pr|pb|pl|m|mx|my|mt|mr|mb|ml|gap|gap-x|gap-y|space-x|space-y)-(?:5|7|9|11)\b/;
...
export const L3 = {
    ...
    checkTsx(file, source) {
        return findInStringLiterals(file, source, "L3", PATTERN, (match) => `off the scale: ${match} — use the nearest allowed step (spacing 0.5 1 1.5 2 3 4 6 8 10 12, never 5/7/9/11), or promote the value to a token if it is needed repeatedly`);
    },
};
